...
// City image route using Google Custom Search API
app.get('/api/city-image', async (req, res) => {
  try {
    ...
    const keywords = ['city', 'landmark', 'cityscape', 'city-view']; // If you're seeing this you can add keywords in here in this format -> 'example1', 'example2'
...
// Serve city names from cities.json
...
// Check if city is valid in Weather API
